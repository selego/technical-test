...
const ProjectList = () => {
  ...
  return (
    <div className="w-full p-2 md:!px-8">
      <Create onChangeSearch={handleSearch} activeProjects={activeProjects} setActiveProjects={setActiveProjects} />
      <div className="py-3">
...
const Create = ({ onChangeSearch, activeProjects, setActiveProjects }) => {
            ...
            <Formik
              ...
              onSubmit={async (values, { setSubmitting }) => {
                try {
                  ...
                  setActiveProjects([...activeProjects, res.data]);
                  setOpen(false);
                } catch (e) {
                  console.log(e);
